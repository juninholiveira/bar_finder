...
function initMap()
{
  ...
  let center = new google.maps.LatLng(parseFloat(userCoords.lat), parseFloat(userCoords.lng))
  let radius = 8000
  ...
  // let request = {location: userCoords, radius: radius, types: ['bar', 'restaurant']}
  // let request2 = {location: userCoords, radius: radius, query: 'restaurante'}
  // let request3 = {location: userCoords, radius: radius, query: 'bar'}
  // let request4 = {location: userCoords, radius: radius, query: 'lanchonete'}
  // let request5 = {location: userCoords, radius: radius, query: 'fast-food'}
  // let request6 = {location: userCoords, radius: radius, query: 'churrasco'}
  // let request7 = {location: userCoords, radius: radius, query: 'hamburguer'}
  // let request8 = {location: userCoords, radius: radius, query: 'pizza'}
